<%@ Page Title="" Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="YhglAdd.aspx.cs" Inherits="cwglxt.YhglAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="form-group">
    <asp:Label ID="Label1" runat="server" Text="账号" for="yhzh"></asp:Label>
    <asp:TextBox ID="yhzh" runat="server" placeholder="请输入账号" CssClass="form-control"></asp:TextBox>
