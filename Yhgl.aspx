<%@ Page Title="" Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="Yhgl.aspx.cs" Inherits="cwglxt.Yhgl" %>
...
<div class="mt-2">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cwglxtConnectionString %>" SelectCommand="SELECT * FROM [yhxx]"></asp:SqlDataSource>
</div>
</asp:Content>
